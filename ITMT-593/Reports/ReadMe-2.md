...
![BadgeCloning](images/2/5.JPG "Badge Cloning")
...
Therefore, when experts create one smart technology based product perfectly they must make sure that train the users of that product perfectly too in order to prevent social engineering attacks.
