...
* The Database has an Id AUTO-INCREMENT column. Also, the temperature data type is Integer
...
** **AvgTemperature.java** contains the Mapper and Reducer, and Job to produce the result for part 1
** **AvgTemperatureLimit.java** contains the Mapper and Reducer, and Job to produce the result for part 2
